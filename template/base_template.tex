...
% Header ve footer logolarının ortak genişliği
\newcommand{\logoW}{2.8cm}
...
\item[1A.] Protein kodlanan bir bölge veya işlevsel olarak önemli olduğu bilinen bölge içermektedir.
\item[1B.] Protein kodlanan veya işlevsel olarak önemli olduğu bilinen herhangi bir bölge içermemektedir.
\item[2A.] Bilinen bir TS (Triplosensitive) geni veya kritik genomik bölge kopya kazancı içinde tamamen yer almaktadır.
\item[2C.] Bilinen benign kopya kazancı ile gen içeriği aynıdır.
\item[2D.] Bilinen benign kopya kazancından daha küçüktür; kırılma noktaları protein kodlayan genleri kesintiye uğratmamaktadır.
\item[2E.] Bilinen benign kopya kazancından daha küçüktür; kırılma noktaları protein kodlayan bir geni kesintiye uğratabilir.
\item[2F.] Bilinen benign kopya kazancından daha büyüktür; ek protein kodlayan genler içermemektedir.
