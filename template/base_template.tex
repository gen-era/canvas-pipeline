...
% PDF ve linkler (çoğu paketten sonra yükle)
\usepackage{url}
...
Mikroarray yöntemi ile elde edilen verilerin analizinde SMN1ve SMN2 genlerinin ayırıcı probları bulunmamaktadır. Bu bölgelerdeki kopya sayısı değişimlerinin saptanabilmesi için başka bir yöntem ile çalışılması önerilmektedir.

Gen anotasyonları UCSC Genome Browser OMIM Genleri veri kümesi ile NCBI Gene veritabanındaki Homo sapiens gene info ve mim2gene medgen veri setleri kullanılarak gerçekleştirilmiştir.
...
\textbf{1 kb} = 1000 bp \\
\textbf{DEL}: delesyon \\
\textbf{DUP}: duplikasyon \\
\textbf{CNV Güven Düzeyi}: Tespit edilen CNV'nin güvenilirlik seviyesidir.
...
ClinGen Dosage Sensitivity Curation Page: https://dosage.clinicalgenome.org/
...
\bibitem{decipher}
DECIPHER database: https://www.deciphergenomics.org

\bibitem{rare}
UNIQUE Database: https://www.rarechromo.org
...
\bibitem{ucsc}
UCSC Genome Browser OMIM Genleri veri kümesi (GRCh37/hg19), erişim tarihi: 16.03.2026. \\
https://genome.ucsc.edu

\bibitem{geneinfo}
NCBI Gene veritabanı: Homo\_sapiens.gene\_info veri kümesi, indirilme tarihi: 16.03.2026. \\
https://www.ncbi.nlm.nih.gov/gene

\bibitem{mim2gene}
NCBI mim2gene\_medgen veri kümesi, indirilme tarihi: 16.03.2026. \\
https://www.ncbi.nlm.nih.gov/gene

\bibitem{acmg}
Riggs ER et al. Technical standards for the interpretation and reporting of constitutional copy-number variants: a joint consensus recommendation of the American College of Medical Genetics and Genomics (ACMG) and the Clinical Genome Resource (ClinGen). \\
Genetics in Medicine. 2020;22(2):245–257.

\bibitem{iscn}
McGowan-Jordan J., Hastings R.J., Moore S. (eds). ISCN 2020: An International System for Human Cytogenomic Nomenclature (2020). \\
Cytogenetic and Genome Research. Karger, 2020.
