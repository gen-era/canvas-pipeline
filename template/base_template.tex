...
\usepackage[paper=a4paper,top=0.5cm,bottom=1.5cm,left=1.5cm,right=1.5cm,headsep=0.5cm,headheight=5cm,includehead,includefoot,twoside]{geometry}
...
\newcommand{\protocolId}{%%protocolId%%}
\newcommand{\summaryDate}{%%summaryDate%%}
\newcommand{\chipId}{%%chipId%%}
\newcommand{\chipPosition}{%%chipPosition%%}
\newcommand{\chipType}{%%chipType%%}
\newcommand{\canvasVersion}{%%canvasVersion%%}
...
% Tek noktadan logo boyutu kontrolü
\newcommand{\logoW}{2.0cm} % gerekirse 1.8cm / 2.2cm yap
...
% -------- Header: Sol sayfalar (LO) --------
\fancyhead[LO]{%
    \begin{tabularx}{\textwidth}{m{2.2cm} X m{2.2cm}}
        \includegraphics[width=\logoW]{canvas_logo.png} &
        \centering\bfseries\sffamily\Huge{Array Özeti} &
        \centering\includegraphics[width=\logoW]{genera_logo.png}
    \end{tabularx}\\[-0.15em]
    {\centering\sffamily\small \thepage\ /\ \pageref{LastPage}\par}
    \vspace{0.35em}
    \begin{tabularx}{\textwidth}{m{7.0cm} L m{4.0cm}}
        \hline
        \bfseries{Hasta Kodu} & \bfseries{Tarih} & \bfseries{Kurum} \\
        \sffamily \protocolId & \sffamily \summaryDate & \sffamily \institute \\
        \bfseries{Çip tipi} & \bfseries{Çip barkodu} & \bfseries{Position} \\
        \sffamily \chipType & \sffamily \chipId & \sffamily \chipPosition \\
        \hline
    \end{tabularx}%
}

% -------- Header: Sağ sayfalar (RE) --------
\fancyhead[RE]{%
    \begin{tabularx}{\textwidth}{m{2.2cm} X m{2.2cm}}
        \includegraphics[width=\logoW]{genera_logo.png} &
        \centering\bfseries\sffamily\Huge{Array Özeti} &
        \centering\includegraphics[width=\logoW]{canvas_logo.png}
    \end{tabularx}\\[-0.15em]
    {\centering\sffamily\small \thepage\ /\ \pageref{LastPage}\par}
    \vspace{0.35em}
    \begin{tabularx}{\textwidth}{m{7.0cm} L m{4.0cm}}
...
% -------- Footer: Sol sayfalar (LO) --------
\fancyfoot[LO]{%
    \hrule
    \sffamily
    \begin{tabularx}{\textwidth}{m{3.0cm} X m{3.0cm}}
        \includegraphics[width=\logoW]{canvas_logo.png} &
        \centering SNP array summary &
        \includegraphics[width=\logoW]{genera_logo.png}
    \end{tabularx}\\[-0.3em]
    \sffamily \canvasVersion
}

% -------- Footer: Sağ sayfalar (RE) --------
\fancyfoot[RE]{%
    \hrule
    \sffamily
    \begin{tabularx}{\textwidth}{m{3.0cm} X m{3.0cm}}
